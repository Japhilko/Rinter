...
-  Die Pakete `lattice` und ggplot2 erweitern die Funktionalität
-  Eine weit über diese Einführung hinausgehende Übersicht findet sich in Murrell, P (2. Ausgabe 2012): R Graphics.


![](../figure/PaulMurrel.jpg)
...
Wir erstellen ein Histogramm der Variable gcsescore (Hilfe mit `?hist`):
...
# Scatterplot wird erzeugt
plot(x, y, xlim=c(-5,5), ylim=c(-5,5))

# Vioplot wird entlang der y-Achse geplottet
vioplot(x, col="tomato", horizontal=TRUE, at=-4, 
        add=TRUE,lty=2, rectCol="gray")

# Vioplot wird entlang der x-Achse geplottet
